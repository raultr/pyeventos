...
class EventoAdmin(admin.ModelAdmin):
	list_display =('id','descripcion','criticidad_capturista','criticidad_evaluador','reporta','fecha_capturista','fecha_filtro','fecha_evaluador','revisada')
	list_filter =('cdu_estado','cdu_fuente','criticidad_capturista','criticidad_evaluador','revisada')
	search_fields = ('descripcion',) # Campos por los que se puede buscar, si son campos foraneos se usa campo__nomcampoforaneo
