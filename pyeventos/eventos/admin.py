...
class EventoAdmin(ImportExportActionModelAdmin):
	list_display =('id','revisada','prioridad','descripcion','criticidad_capturista','cdu_fuente','cdu_estado','cdu_municipio','criticidad_evaluador','mediano','reporta','fecha_capturista','fecha_filtro','fecha_evaluador','observaciones')
	list_filter =('cdu_estado','cdu_fuente','prioridad','criticidad_capturista','criticidad_evaluador','revisada')
