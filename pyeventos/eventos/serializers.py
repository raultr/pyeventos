...
class EventoSerializer(serializers.ModelSerializer):
	fecha_capturista = serializers.DateTimeField(format='%d/%m/%Y %I:%M %p')
	fecha_filtro =serializers.DateTimeField(format='%d/%m/%Y %I:%M %p')
	fecha_evaluador =serializers.DateTimeField(format='%d/%m/%Y %I:%M %p')

	class Meta:
		model = Evento

		fields=('id','descripcion','cdu_fuente','criticidad_capturista','criticidad_evaluador','prioridad','reporta','cdu_estado',
